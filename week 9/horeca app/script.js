...
function vraag2(){
    vraag = prompt("wat wil je bestellen wijn kost 4.25 euro, bier kost 2.85 euro of fris kost 1.95 euro. type snack om bitterballen te bestellen. als u klaar bent zeg dan stop.")
        if (vraag == "wijn"){
            ...
            var aantalbb = prompt("hoeveel bitterballen wilt u bestellen? 8 of 16")
            ...
            if (aantalbb == "8"){
                ...
                alert("wij verkopen geen bitterballen in deze hoeveelheid!")
                vraag2();
            }
        }
        else if (vraag == "stop"){
            ...
            alert("U heeft een ongeldig aantal ingevoerd. Uw bestelling kan niet worden toegevoegd.")
            vraag2();
        }
    }       
vraag2();